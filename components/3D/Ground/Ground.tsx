...
const Grid = ({
  ...
  const poolHeight = Pools[ClosestPoolIndex]
    ? Pools[ClosestPoolIndex].height
    : poolheight;
        ...
        if (closestPool) {
          ...
          if (closestPool.poolType === "lshape") {
            ...
            setCornerStep([
              ...
              {
                position: [
                  -closestPool.width / 2 + BenchDepth,
                  cornerHeightBottomPosition,
                  -closestPool.depth / 2 + BenchDepth,
                ],
                used: false,
              }, //bottomleft (TopLeft)
              {
        ...
        switch (type) {
          ...
          case "cornerStep":
            if (SnappingPosition) {
              ...
              switch (ClosestIndex) {
                case 0:
                  side = sides.Left; // topleft
                  rotationx = Math.PI / 2;
                  rotationz = Math.PI / 2 + Math.PI / 4;
                  break;
                case 1:
                  side = sides.Right; // topright
                  rotationx = Math.PI / 2;
                  rotationz = -(Math.PI / 2 + Math.PI / 4);
                  break;
                case 2:
                  side = sides.Top; // Bottomleft
                  rotationx = Math.PI / 2;
                  rotationz = Math.PI / 4;
                  break;
                case 3:
                  side = sides.Bottom; // Bottomright
                  rotationx = Math.PI / 2;
                  rotationz = -Math.PI / 4;
                  break;

                case 4:
                  side = sides.BottomLeft; //BOTTOM topleft
                  rotationx = Math.PI / 2;
                  rotationz = Math.PI / 2 + Math.PI / 4;
                  break;
                case 5:
                  side = sides.BottomRight; //BOTTOM topright
                  rotationx = Math.PI / 2;
                  rotationz = -(Math.PI / 2 + Math.PI / 4);
                  break;
                case 6:
                  side = sides.BottomTop; //BOTTOM Bottomleft
                  rotationx = Math.PI / 2;
                  rotationz = Math.PI / 4;
                  break;
                case 7:
                  side = sides.BottomBottom; //BOTTOM Bottomright
                  rotationx = Math.PI / 2;
                  rotationz = -Math.PI / 4;
                  break;
              }
