        ...
        <group ref={parentRef}>
          <group ref={ref} matrix={matrix} matrixAutoUpdate={false}>
            <group visible={visible} ref={gizmoRef} position={offset} rotation={rotation}>
              {!disableAxes && activeAxes[0] && <AxisArrow snapTranslate={snapTranslate} axis={0} direction={xDir} />}
              {!disableAxes && activeAxes[1] && <AxisArrow axis={1} direction={yDir} />}
              {!disableAxes && activeAxes[2] && <AxisArrow axis={2} direction={zDir} />}

              {!disableScaleAxes && activeAxes[0] && <SphereScale axis={0} direction={xDir} />}
              {!disableScaleAxes && activeAxes[1] && <SphereScale axis={1} direction={yDir} />}
              {!disableScaleAxes && activeAxes[2] && <SphereScale axis={2} direction={zDir} />}
